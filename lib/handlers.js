...
handlers.index = (data, callback) => {
    if (data.method === 'get') {
        ...
        const templateData = {
            ...
            'head.description': 'We offer free simple uptime monitoring for HTTP/HTTPS sites of all kinds. If your site goes down, we\'ll send you a text to let you know',
            'body.class': 'index'
        };
